package no.nav.cache.filter

import no.nav.cache.util.CallIdGenerator
import no.nav.cache.util.Constants
...
class HeadersToMDCFilterBean(
        ...
        @Value("\${spring.application.name:k9-brukerdialog-cache}") private val applicationName: String) : GenericFilterBean() {
